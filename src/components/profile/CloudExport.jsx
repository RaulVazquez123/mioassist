    ...
    <div className="rounded-3xl border border-border/70 bg-card p-5 soft-shadow flex flex-col">
      ...
      <div className="rounded-2xl bg-secondary/60 border border-border/60 px-4 py-3 mb-4 flex items-center justify-between gap-3">
        ...
        <button
          onClick={handleSync}
          className={cn(
            "w-8 h-8 rounded-xl bg-card border border-border flex items-center justify-center hover:bg-secondary transition-all",
      ...
      <div className="space-y-2 flex-1">
        {REPORTS.map((r, i) => (
          <div
            key={i}
            className="flex items-center gap-3 px-3 py-2.5 rounded-xl bg-background border border-border/60 hover:border-border transition-all"
          >
      ...
      <div className="mt-4 grid grid-cols-2 gap-2">
        ...
        <Button size="sm" className="h-9 rounded-xl text-xs gap-1.5 bg-primary text-primary-foreground">
