  ...
  return (
    <div className="relative rounded-3xl border border-border/70 bg-card soft-shadow overflow-hidden">
      ...
      <Textarea
        ...
        className="min-h-[180px] sm:min-h-[220px] text-2xl sm:text-3xl leading-relaxed font-light border-0 focus-visible:ring-0 focus-visible:ring-offset-0 resize-none px-6 sm:px-8 pb-8 bg-transparent placeholder:text-muted-foreground/50"
      />
    </div>
  );
}